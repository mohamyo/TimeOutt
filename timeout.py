...
b1 = Button(pane, text="sign up", background="#4566ba", fg="white",command=sign)
b1.pack(expand=True, fill=BOTH)
b2 = Button(pane, text="login",
            background="#4566ba", fg="white",command=log)
b2.pack( expand=True, fill=BOTH)
b3 = Button(pane, text="information",
            background="#4566ba", fg="white")
b3.pack( expand=True, fill=BOTH)
b4 = Button(pane, text="exit",
            background="#4566ba", fg="white",command=exit)
